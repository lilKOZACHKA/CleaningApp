...
################################################################################
## Form generated from reading UI file 'ChangeUserDialogYIprit.ui'
##
...
class Ui_ChangeUserDialog(object):
    def setupUi(self, ChangeUserDialog):
        ...
        ChangeUserDialog.setStyleSheet(u"background-color:qlineargradient(spread:pad, x1:1, y1:1, x2:0, y2:0, stop:0 rgba(81, 0, 135, 255), stop:0.427447 rgba(41, 61, 132, 235), stop:1 rgba(155, 79, 165, 255));\n"
"\n"
...
"font-size: 10pt;")
        ...
        self.new_status_input.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.new_status_input.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
